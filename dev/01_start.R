...
golem::fill_desc(
  ...
  repo_url = 'https://github.com/jhmigueles/FIBIONsummary.git' # The URL of the GitHub Repo (optional) 
)     
...
usethis::use_mit_license( "Jairo H Migueles" )  # You can set another license here
usethis::use_readme_rmd( open = FALSE )
usethis::use_code_of_conduct(contact = "jairo.hidalgo.migueles@gmail.com")
